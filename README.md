...
- 最新版本：ArticleRead 0.1.12（macOS 与 Linux 同步发布）
- macOS：Apple Silicon / arm64，从 [v0.1.12](https://github.com/zhikangSu/ArticleRead/releases/tag/v0.1.12) 下载 `ArticleRead-0.1.12-arm64.dmg`
- Linux：x64，从 [v0.1.12](https://github.com/zhikangSu/ArticleRead/releases/tag/v0.1.12) 下载 `articleread-linux-desktop_0.1.12_amd64.deb` 或 `ArticleRead-0.1.12.AppImage`
- SHA256（0.1.12 macOS）：
  - DMG：`005be1a20af4ea1ab7ba1e89c681692240113c95c59a2eab656268de1fb2fcd4`
  - macOS ZIP：`91ca6e0a990389bdad63c0614ee0f707f0b3cf7f36bf271a084299f50c6b8e62`
- SHA256（0.1.12 Linux）：
  - AppImage：`9a0a165b03b3213a33f36d2c1914b4be1f03236d530ac963f90474b11f36945a`
  - deb：`dd8642f6890684efa650a5f922e60c5319c3c184f301435921f40f3c68c5d1fd`
...
1. 从 Releases 下载 `ArticleRead-0.1.12-arm64.dmg`。
...
```bash
sudo dpkg -i articleread-linux-desktop_0.1.12_amd64.deb
```

也可以直接运行 AppImage：

```bash
chmod +x ArticleRead-0.1.12.AppImage
./ArticleRead-0.1.12.AppImage
```
