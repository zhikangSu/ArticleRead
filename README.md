...
- 最新版本：ArticleRead 0.1.11（macOS；Linux 版稍后发布，当前请使用 v0.1.6）
- macOS：Apple Silicon / arm64，从 [v0.1.11](https://github.com/zhikangSu/ArticleRead/releases/tag/v0.1.11) 下载 `ArticleRead-0.1.11-arm64.dmg`
...
- SHA256（0.1.11 macOS）：
  - DMG：`3c712d1241548a161e7601048ecd467015411ccb9992d19588431fcaadb72170`
  - macOS ZIP：`bfe2998976da8eb3027fa76768269b09969388c6eb3aa9ef126202617a84e557`
...
- 修复 0.1.10 打开应用即崩溃(`buildAppMenu is not defined`)的问题;以下为 0.1.10 引入的功能:
...
1. 从 Releases 下载 `ArticleRead-0.1.11-arm64.dmg`。
