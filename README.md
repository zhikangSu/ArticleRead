...
- 最新版本：macOS 0.1.14；Linux 0.1.13（0.1.14 安装包稍后追加）
- **从 0.1.13 起支持应用内内核更新**：兼容当前壳的后续功能更新可在设置页一键完成；涉及桌面壳的版本仍需下载完整安装包
- macOS：Apple Silicon / arm64，从 [v0.1.14](https://github.com/zhikangSu/ArticleRead/releases/tag/v0.1.14) 下载 `ArticleRead-0.1.14-arm64.dmg`
...
- SHA256（0.1.14 macOS）：
  - DMG：`51befed9c91b52635fadc491cd188563dde1cac8e27d7569612c7a030f5efbdf`
  - macOS ZIP：`4e8d272b6cc443e73b68237abc1fdc0b6874d8fd6612cbc6eae3bc69c96f48e0`
- SHA256（0.1.13 Linux）：
...
- 新版透明 App 图标；arXiv 元数据限流时自动节流并回退到官方论文页，不再直接留下错误卡片
...
1. 从 Releases 下载 `ArticleRead-0.1.14-arm64.dmg`。
