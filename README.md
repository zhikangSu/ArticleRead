...
- SHA256（0.1.15 macOS）：
  - DMG：`0825c6faca64f1067e71d8f4f15351727b198f73fc5e0a95ac7914d7de3b0a68`
  - macOS ZIP：`980c1e95b0b4289150ccb0e6af681ed34d566b52529f66ff07634be76977407e`
- SHA256（0.1.13 Linux）：
...
- 完整安装包已内置 paperq 2.20.1；0.1.14 用户也可以通过应用内更新获取本次内核功能

> 0.1.14 用户若只需要首次引导与标签页修复，可以直接使用应用内更新；若要获得修正后的 Dock 图标，需要安装一次 0.1.15 完整版。新下载的 0.1.15 已内置 2.20.1，不会再重复下载同一增量包。
