...
- SHA256（0.1.15 macOS）：
  - DMG：`6fd911dcbb78ee03f7803a51910c6bff5ae4213fac1a06380c35c1569eaf5386`
  - macOS ZIP：`ece434cdc48119776ba40681bb555144f26286511b6a9b0a72cc3b9cfc9d8bd5`
- SHA256（0.1.13 Linux）：
...
- 提问框在留白足够时停靠到论文侧边；放大页面或展开问答面板时自动回退到选区附近
- 右侧问答面板支持拖到右缘收起，并可从右缘反向拖开；同时保留点击与双击操作
- 使用现代 macOS 图标资源管线，移除旧式透明 `.icns` 触发的灰色兼容底板，并放大图标主体
- 完整安装包已内置 paperq 2.20.3；0.1.14 用户也可以通过应用内更新获取本次内核功能

> 0.1.14 用户若只需要本次内核功能，可以直接使用应用内更新；若要获得修正后的 Dock 图标，需要安装一次 0.1.15 完整版。新下载的 0.1.15 已内置 2.20.3，不会再重复下载同一增量包。
